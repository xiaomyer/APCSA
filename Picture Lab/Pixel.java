...
public class Pixel
{
  ...
  private DigitalPicture picture; //the digital picture this pixel belongs to
  private int x; //the x-coordinate (column) of this pixel
  private int y; //the y-coordinate (column) of this pixel
  ...
  //returns the x-coordinate of the pixel in the picture
  public int getX() { return x; }
 
  //returns the y-coordinate of the pixel in the picture
  public int getY() { return y; }
  
  //returns the row value - this is the same as getting the y-coordinate
  public int getRow() { return y; }
 
  //returns the column value - this is the same as getting the x-coordinate
  public int getCol() { return x; }

  //get the alpha value (transparency), it will be from 0-255
  public int getAlpha() {
